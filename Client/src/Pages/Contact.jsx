    ...
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      >
        <div
          ...
          className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[35deg] bg-gradient-to-tr from-[#2a4dc2] to-[#117de2] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
        />
      </div>
